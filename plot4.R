...
plot(powerdata2$Date, powerdata2$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

# plot #2: Voltage
plot(powerdata2$Date, powerdata2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(powerdata2$Date, powerdata2$Global_reactive_power, type = "l", ylab = "Global reactive power", xlab = "datetime")
